...
import { obtenerContratista } from "../../redux/auth/authDucks";

const Contratista = (props) => {
    ...
    useEffect(() => {
        ...
        var data = {
            contratista_id: id_contratista,
        };

        if (data.contratista_id !== undefined && data.contratista_id !== null) {
            // dispatch(obtenerContratista(data))
            filtrarContratista(data);
        }
