    ...
    return {
      ...
      designation: (
        <div className="form-check form-check-inline">
          <CustomInput type="checkbox" id={"crear" + key} label="" />
        </div>
      ),
      age: (
        <div className="form-check form-check-inline">
          <CustomInput type="checkbox" id={"ss" + key} label="" />
        </div>
      ),
      actions: (
        <div>
          <div className="form-check form-check-inline">
            <CustomInput type="checkbox" id={"actualizar" + key} label="" />
          </div>
        </div>
      ),
    };
